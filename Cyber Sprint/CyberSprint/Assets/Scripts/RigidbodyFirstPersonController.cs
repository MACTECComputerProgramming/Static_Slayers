...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            public float ForwardSpeed = 1000f;   // Speed when walking forward
            public float BackwardSpeed = 80f;  // Speed when walking backwards
            public float StrafeSpeed = 30f;    // Speed when walking sideways
            public float SpeedInAir = 10f;   // Speed when onair
